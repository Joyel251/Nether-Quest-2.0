              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-white/20 bg-black/40 backdrop-blur-sm px-4 sm:px-6 py-3 sm:py-4 text-base sm:text-lg text-white placeholder:text-white/50 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500/50 transition-all duration-200"
                    disabled={submitting}
                    autoComplete="off"
                  />
                </div>
