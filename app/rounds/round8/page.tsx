...
export default function round8() {
  ...
  const { question, error, loading, clue1, clue2 } = useQuestion();
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full rounded-xl border bg-black/40 backdrop-blur-sm px-4 sm:px-6 py-3 sm:py-4 text-base sm:text-lg text-white placeholder:text-white/50 focus:outline-none transition-all duration-300
                      ${isSubmitted ? (answerStatus === 'correct' ? 'border-emerald-500 ring-2 ring-emerald-500/50' : 'border-red-500 ring-2 ring-red-500/50') : 'border-white/20 focus:ring-red-500/50 focus:border-red-500/50'}
                    `}
