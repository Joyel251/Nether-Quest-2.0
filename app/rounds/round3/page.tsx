        ...
        <div className="max-w-2xl w-full text-center">
          <div className="relative bg-gradient-to-br from-zinc-950/90 to-black/85 border border-white/10 backdrop-blur-xl rounded-3xl p-8 sm:p-12 shadow-2xl overflow-hidden">
            ...
            <div className="inline-flex items-center gap-4 mb-8">
              ...
              <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-400 to-red-500 drop-shadow">
                Round 3
              </h1>
            </div>
